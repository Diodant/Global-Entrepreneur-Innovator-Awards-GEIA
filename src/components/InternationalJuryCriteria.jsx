    ...
    <>
          ...
          <div className="hero__columns">
            <div>
              <h1 className="hero__title" style={{ visibility: "visible" }}>
                {tr("juryCriteria.page.title", "Jury selection process")}
              </h1>
            </div>
          </div>
      ...
      <div className="blocks-container">
        <p className="nom_title">
          {tr(
            "juryCriteria.title",
            "Criteria for Selection and Composition of the International Jury of GEIA"
          )}
        </p>
        ...
        <p>{tr("juryCriteria.p2", "Composition and Qualification Requirements for Jury Members:")}</p>
        ...
        <p>{tr("juryCriteria.h1", "Documented International Recognition and Reputation")}</p>
        ...
        <p>{tr("juryCriteria.p6", "Recognition in professional and business circles:")}</p>

        <ul className="wp-block-list">
          {trList("juryCriteria.list2", [
            ...
            <li key={`list2-${idx}`}>{item}</li>
          ))}
        </ul>

        <p>{tr("juryCriteria.p7", "Confirmation of reputation by independent authoritative sources:")}</p>

        <ul className="wp-block-list">
          {trList("juryCriteria.list3", [
            ...
            <li key={`list3-${idx}`}>{item}</li>
          ))}
        </ul>

        <p>{tr("juryCriteria.h2", "Demonstrated Professional Experience at the Highest Level")}</p>
        ...
        <p>{tr("juryCriteria.h3", "Impeccable Business Reputation and Ethical Suitability")}</p>
