...
export default function Conector() {
  ...
  return (
    <div className="wp-block-group alignwide wp-block-group--no-inner-margin wp-block-group--email-alert-new is-layout-flow wp-block-group-is-layout-flow">
      <div className="wp-block-columns is-layout-flex wp-container-core-columns-is-layout-5 wp-block-columns-is-layout-flex">
        ...
        <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
          <h2 className="wp-block-heading has-h-2-font-size">
            {tr("conector.left.title", "Connect with us")}
          </h2>

          <div className="wp-block-group wp-block-social-icons is-layout-constrained wp-block-group-is-layout-constrained">
            <ul
            ...
            >
              <li className="wp-social-link wp-social-link-instagram wp-block-social-link">
                <a href="/" className="wp-block-social-link-anchor">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                  ...
                  <span className="wp-block-social-link-label screen-reader-text">
                    {tr("conector.social.instagram", "Instagram")}
                  </span>
                </a>
              </li>
              ...
              <li className="wp-social-link wp-social-link-facebook wp-block-social-link">
                <a href="/" className="wp-block-social-link-anchor">
                  ...
                  <span className="wp-block-social-link-label screen-reader-text">
                    {tr("conector.social.facebook", "Facebook")}
                  </span>
                </a>
              </li>
              ...
              <li className="wp-social-link wp-social-link-linkedin wp-block-social-link">
                <a href="/" className="wp-block-social-link-anchor">
                  ...
                  <span className="wp-block-social-link-label screen-reader-text">
                    {tr("conector.social.linkedin", "LinkedIn")}
                  </span>
                </a>
              </li>
              ...
              <li className="wp-social-link wp-social-link-youtube wp-block-social-link">
                <a href="/" className="wp-block-social-link-anchor">
                  ...
                  <span className="wp-block-social-link-label screen-reader-text">
                    {tr("conector.social.youtube", "YouTube")}
                  </span>
                </a>
              </li>

              <li className="wp-social-link wp-social-link-flickr wp-block-social-link">
                <a href="/" className="wp-block-social-link-anchor">
                  <svg
                    width="24"
                    height="24"
                  ...
                  <span className="wp-block-social-link-label screen-reader-text">
                    {tr("conector.social.flickr", "Flickr")}
                  </span>
                </a>
              </li>
            </ul>
        ...
        {/* Right column */}
        <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
          <p className="is-style-large">
            {tr(
              "conector.right.text",
              "Want the latest GEIA news and activities delivered directly to your inbox?"
            )}
          </p>
